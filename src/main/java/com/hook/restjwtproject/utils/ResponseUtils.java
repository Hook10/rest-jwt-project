...
public class ResponseUtils {
    ...
    public static final String CHANGE_ROLE_MESSAGE = "The role from %s have been successfully changed";
    ...
    public static final String JPA_OBJECT_RETRIEVAL_FAILURE_EXCEPTION_MESSAGE = "The data entered violates the established requirement";
    public static final String ACCESS_DENIED_EXCEPTION_MESSAGE = "You don't have access permission";
    public static final String MALFORMED_JWT_EXCEPTION_MESSAGE = "Incorrect token";
    public static final String EXPIRED_JWT_EXCEPTION_MESSAGE = "The lifecycle of token is completed";
