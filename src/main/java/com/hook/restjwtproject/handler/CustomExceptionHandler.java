...
import static com.hook.restjwtproject.utils.Constants.BOOK_NOT_FOUND_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.BAD_CREDENTIALS_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.DATA_INTEGRITY_VIOLATION_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.DATA_SOURCE_LOOKUP_FAILURE_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.ENTITY_NOT_FOUND_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.JPA_OBJECT_RETRIEVAL_FAILURE_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.METHOD_ARGUMENT_NOT_VALID_EXCEPTION_MESSAGE;
import static com.hook.restjwtproject.utils.ResponseUtils.getErrorsValidationResponse;
import static com.hook.restjwtproject.utils.ResponseUtils.getExceptionResponse;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<BaseResponse> handleException(HttpMessageNotReadableException exception) {
        ExceptionResponse response = getExceptionResponse(
                HttpStatus.INTERNAL_SERVER_ERROR,
                ResponseUtils.HTTP_MESSAGE_NOT_READABLE_EXCEPTION_MESSAGE,
                exception
        );
        return new ResponseEntity<>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    }
